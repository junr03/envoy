...
public:
  ...
  /**
   * @return std::vector<std::reference_wrapper<Network::AbstractListener>> a list of the currently
   ...
   */
  virtual std::vector<std::reference_wrapper<Network::AbstractListener>> listeners() PURE;
